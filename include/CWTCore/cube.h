...
assert_size(CWT::cube::Projectile, 0x80);
assert_size(CWT::cube::GUI, 0x5D0);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_HitPacket, 0x48);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_SoundPacket, 0x30);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_ParticlePacket, 0x48);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_CubeChange, 0x20);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_ProjectilePacket, 0x80);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet5, 0x18);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet6, 0x18);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet7, 0x8);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_PickupItemPacket, 0xD0);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet9, 0x10);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet10, 0x28);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet11, 0x18);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_BuffPacket, 0x30);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet13, 0x8);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet14, 0x8);
assert_size(CWT::cube::ServerUpdateSubpackets::SU_Packet15, 0x20);
